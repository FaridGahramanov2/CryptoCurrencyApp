...
URL: https://api.coingecko.com/api/v3/coins/bitcoin?localization=false&tickers=false&market_data=false&community_data=false&developer_data=false&sparkline=false
 ...
 response :
 {
   ...
   "sentiment_votes_up_percentage": 73.17,
   "sentiment_votes_down_percentage": 26.83,
   "market_cap_rank": 1,
   "coingecko_rank": 3,
   "coingecko_score": 80.325,
   "developer_score": 98.859,
   "community_score": 71.054,
   "liquidity_score": 99.891,
   ...
   "status_updates": [],
   "last_updated": "2021-09-17T21:35:39.149Z"
 }
